...
class PaysController extends AbstractController
{
     ...
     */
    public function index(Request $request, PaginatorInterface $paginator, PaysRepository $paysRepository): Response
    {
        $pays = $paginator->paginate(
            $paysRepository->findBy(['isDeleted' => false]),
    ...
    public function new(Request $request): Response
    {
      ...
      /**
     * @Route("/bulk", name="pays_bulk", methods={"GET","POST"})
     * @Security("is_granted('IS_AUTHENTICATED_FULLY')")
     */
